...
def attack(char_name: str, char_class: str) -> str:
    """Функция генерирующая кол-во очков атаки в зависимости от типа персонажа.
...
def defence(char_name: str, char_class: str) -> str:
    """Функция генерирующаяая кол-во очков защиты в завис-ти от типа персонажа.
    Возвращает строковое сообщение о выполненном блокировании
    атаки.
    """
    if char_class == 'warrior':
